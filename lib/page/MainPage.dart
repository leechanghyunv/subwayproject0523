...
import '../custom/DialogButton.dart';
import '../custom/FormFieldA.dart';
import '../custom/FormFieldB.dart';
import '../custom/IconButtonCustom.dart';
import '../custom/SwitchDialogA.dart';
import '../custom/SwitchDialogB.dart';
import '../custom/TextFrame.dart';
import '../custom/ToggleSwitch.dart';
import '../custom/TransferButton.dart';
import '../custom/UpandDown.dart';
import '../model/ZsubwayModel.dart';
import '../parts/BottomDesign.dart';
import '../parts/ColorBar.dart';
import '../custom/DropDown.dart';
import '../parts/DesignTextA.dart';
import '../parts/DesignTextB.dart';
import '../parts/TopDesign.dart';
                                                ...
                                                DialogButton(
                                                  onPressed: (){
                                                    if(subwayname != 'SEOUL'){
                                                      ...
                                                      box.write('convertA',Datas.LineStringB);
                                                      Savemsg(
                                                          '목적지 A',subwayname,Datas.engName
                                                      );
                                                    }else if(subwayname == 'SEOUL'){
                                                      Showmsg();
                                                    }
                                                  ...
                                                  onLongPress: (){
                                                    if(subwayname != 'SEOUL'){
                                                      ...
                                                      box.write('convertB',Datas.LineStringB);
                                                      Savemsg(
                                                          '목적지 B',subwayname,Datas.engName
                                                      );
                                                    }else if(subwayname == 'SEOUL'){
                                                      Showmsg();
                                                    }
